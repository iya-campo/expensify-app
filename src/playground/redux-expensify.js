...
const expenseOne = store.dispatch(
  addExpense({
    description: 'MONEY FROM DEALING DRUGS',
    note: 'Buy sexy new sports car with it!',
    amount: 10,
    createdAt: 1000,
  })
);
...
//     description: 'MONEY FROM WORKING HARD',
//     note: 'Buy presents for Christmas~',
//     amount: 50,
//     createdAt: 0,
//   })
// );
